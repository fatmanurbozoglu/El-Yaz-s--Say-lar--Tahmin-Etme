...
class MainWidget(QtWidgets.QWidget):
    ...
    def predict(self):
        ...
        arr = np.array(ImageOps.grayscale(Image.fromarray(arr).resize((28, 28), Image.BILINEAR)))
        arr = (arr / 255.0).reshape(1, -1)
        self.prediction.setText('TAHMİN: ' + str(self.loaded_model.predict(arr)[0]))
...
if __name__ == "__main__":
    ...
    mainApp = MainWindow()
    mainApp.setWindowTitle('RAKAM TAHMİNİ')
    mainApp.show()
    sys.exit(app.exec_())